...
HIDDEN_OBJECTS = bump_test.o coalesce_check.o csbrk.o # In case we need to recompile these
...
csbrk.o: csbrk.c csbrk.h
	$(CC) $(CFLAGS) -DTRACK_CSBRK -o csbrk.o -c csbrk.c
...
runner: runner.c umalloc.o check_heap.o err_handler.o support.o 
	$(CC) $(CFLAGS) $(WRAP_FLAGS) -o runner runner.c umalloc.o check_heap.o csbrk.o err_handler.o support.o coalesce_check.o

heap_runner: heap_runner.o check_heap.o umalloc.o err_handler.o support.o
	$(CC) $(CFLAGS) $(WRAP_FLAGS) -o heap_runner heap_runner.o check_heap.o csbrk.o umalloc.o err_handler.o support.o coalesce_check.o

bump_test: check_heap.o umalloc.o err_handler.o support.o
...
performance: performance.c umalloc.o support.o err_handler.o check_heap.o
	$(CC) $(CFLAGS) $(WRAP_FLAGS) -o performance performance.c csbrk.o umalloc.o err_handler.o support.o check_heap.o coalesce_check.o

unittest: unittest.o support.o umalloc.o err_handler.o check_heap.o
